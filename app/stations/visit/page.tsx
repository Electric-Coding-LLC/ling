import { VISIT_STARTER_PHRASES } from "../../../src/modules/travel";
...
export default function VisitPage() {
  return (
    <main className="shell station-shell">
      <StationTopbar current="Visit" mapPosition="visit" />
      <div className="station-page station-page-travel station-page-visit">
        <TravelStation
          framed
          intro={[
            <section
