...
export const PITCH_ACCENT_ITEMS = [
  ...
  {
    audio: "/audio/ja-pitch-nihongo.wav",
    id: "nihongo",
    meaning: "Japanese",
    morae: ["に", "ほ", "ん", "ご"],
    pitch: ["low", "high", "high", "high"],
    sourceEntry: "日本語",
    validationShape: "sustained-high",
    word: "にほんご",
  },
  ...
  {
    audio: "/audio/ja-pitch-kudamono.wav",
    id: "kudamono",
    meaning: "fruit",
    morae: ["く", "だ", "も", "の"],
    pitch: ["low", "high", "low", "low"],
  ...
  {
    audio: "/audio/ja-pitch-nomimono.wav",
    id: "nomimono",
    meaning: "drink",
    morae: ["の", "み", "も", "の"],
    pitch: ["low", "high", "low", "low"],
